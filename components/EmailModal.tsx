...
export const EmailModal: React.FC<EmailModalProps> = ({
  ...
  return (
    <div className={`fixed inset-0 z-50 backdrop-blur-md flex items-center justify-center p-4 ${
      ...
      <div className={`border rounded-2xl max-w-4xl w-full max-h-[92vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 ${
        isDark
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className={`font-bold text-base ${isDark ? 'text-white' : 'text-slate-900'}`}>
                MOM Email Dispatcher & Recipient Config
              </h2>
              <p className={`text-xs ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>{subjectLine}</p>
            </div>
          </div>
        ...
        {showConfig && (
          <div className={`p-4 border-b space-y-3 animate-in fade-in slide-in-from-top-2 ${
            isDark
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                <label className={`block text-[11px] font-bold mb-1 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>To Email(s):</label>
                <input
                  type="text"
                  value={toEmails}
              ...
              <div>
                <label className={`block text-[11px] font-bold mb-1 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>CC Email(s):</label>
                <input
                  type="text"
                  value={ccEmails}
              ...
              <div>
                <label className={`block text-[11px] font-bold mb-1 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>BCC Email(s):</label>
                <input
                  type="text"
                  value={bccEmails}
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 gap-3 pt-1 border-t ${
              ...
              <div>
                <label className={`block text-[11px] font-bold mb-1 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>From Account (Sender Name):</label>
                <input
                  type="text"
              ...
              <div>
                <label className={`block text-[11px] font-bold mb-1 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>Sender Email / Username:</label>
                <input
                  type="email"
        ...
        <div className={`px-6 py-2 border-b flex items-center justify-between ${
          ...
          <div className="flex items-center gap-2">
            <span className={`text-xs ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>View Format:</span>
        ...
        {/* Modal Body / Preview */}
        <div className={`flex-1 overflow-y-auto p-6 ${isDark ? 'bg-slate-950' : 'bg-slate-50'}`}>
          {sendResult && (
          ...
          {activeTab === 'visual' && (
            <div className="bg-white text-slate-900 rounded-xl p-6 shadow-md border border-slate-200 min-h-[400px]">
          ...
          {activeTab === 'code' && (
            <pre className={`p-4 rounded-xl text-xs font-mono overflow-x-auto border leading-relaxed max-h-[450px] ${
              isDark
          ...
          {activeTab === 'text' && (
            <pre className={`p-4 rounded-xl text-xs font-mono whitespace-pre-wrap overflow-x-auto border leading-relaxed max-h-[450px] ${
              isDark
